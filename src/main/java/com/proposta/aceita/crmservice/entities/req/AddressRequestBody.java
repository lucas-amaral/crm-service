...
public class AddressRequestBody {
    ...
    public AddressRequestBody(@JsonProperty("id") Integer id, @JsonProperty("streetId") String streetId, @JsonProperty("number") String number, @JsonProperty("complement") String complement) {
        this.id = id;
    ...
    public String toString() {
        return new StringJoiner(", ", AddressRequestBody.class.getSimpleName() + "[", "]")
                .add("id=" + id)
